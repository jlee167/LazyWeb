...
<html style="height:100%;">
	...
	<body style="background-image:linear-gradient(blue, white); margin:0; height:100%; overflow:hidden;">		
		<?php 
		...
		<!--Login Information-->
		<div id="login" style="margin:auto; width:100%; padding-top:100px; margin-botoom: 0px; margin-top: 0px;">
			<div id="login_manual" style="margin:auto; width:50%; height:50%;">
