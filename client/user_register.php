<?php
	...
	*/
	...
	class DatabaseHandler {
		...
		function connect() {
			$this->$conn = new mysqli($this->$server, $this->$user, $this->$password_, $this->$db);
	...
	// Terminate the session with error messages if database is unavailable.
	if (mysqli_connect_error()) {
		die("Database connection failed: " . mysqli_connect_error());
		$dbg_msg="Connection Failed";
		$msg = "<p>" . $dbg_msg . "</p>";
	...
	/* 
	 *		Abort Login process if any invalid data is present
	 */
